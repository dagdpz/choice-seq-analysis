% function chseq_analyze_trial_seq_all_subj_SDH2D

% spatial_decision_human_2nd_dataset (SDH2D) fMRI
...
for k = 1:length(subject_files),
	O(k).out = chseq_analyze_trial_seq_one_subj_SDH2D([datapath filesep subject_files{k}]);
